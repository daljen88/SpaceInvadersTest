...
public class ThirdEnemy : MonoBehaviour, IHittable
{
    ...
    public void OnHitSuffered(int damage = 1)
    {
        ...
        if (hp <= 0)
        {
            ...
            if (UIManager.instance.totalEnemiesKilled % 7 == 0 && UIManager.instance.totalEnemiesKilled != 0 && Random.Range(0, 11) < 8 /*&&GameManager.Instance.typeGunPossessed.name!="BigGun"*/)
            {
